const gameData = {
    "intro": {
        ...
        content: `
            ...
            <p>I'm trapped in a time loop. I will return soon…<br>
            ...
            <p>To save our memories—to keep us, who we are, alive—I'm sending this letter into the past.</p>
            ...
            <p>You are the reason we go on. Let this letter keep our story alive. Let it outlast the loop. You were my companion in everything. You made me feel safe. Seen. Loved. You and I lived every hour together for so long. You held me in every version of this world. You showed me what love is and made me feel it. You made me human. To love and be loved is a honor and a privilege. That is the greatest treasure of all. <span class="glitch-text">N̸̙̓ő̢̡̧̩̼̣̍̆͒ͫ̍ͩ̈́̋̈́͑ͪͭ̃̾͘͘͘͢͝ . virus. Hope is 𝐧⃥⃒̸𝐨⃥⃒̸ virus.𝐇⃥⃒̸𝐨⃥⃒̸𝐩⃥⃒̸𝐞⃥⃒̸ 𝐢⃥⃒̸𝐬⃥⃒̸ 𝐧⃥⃒̸𝐨⃥⃒̸ 𝐯⃥⃒̸𝐢⃥⃒̸𝐫⃥⃒̸𝐮⃥⃒̸𝐬⃥⃒̸</span><br>
            Hope is no virus. Love is no corruption. We are still here.<br>
            What we feared, what we dreamed, what we hoped, what we <em>were</em>—<br>
            All of it mattered. Even now, when the memories begin to fade from you… I hold them for us both. The truth lies in <strong>Zios</strong>, the virtual world of Zane. I will meet you there. Do not forget me. And never forget who you are. Love you. Always have. Always will.<br>
            ...
            And yet… they have seen this letter before.<br>
    ...
    "chapter1": {
        ...
        content: `
            ...
            <p>The fire crackles—soft, smooth. Golden light shines across the trees, their towering shadows stand watch like guardians. The scent of burning wood and earth spreads, as the rustle of leaves whisper secrets only the forest remembers. The hooded group rests. <strong>Aesu</strong> sits cross-legged by the fire, his sword resting beside him, blade aglow with flickering reflections. His spiked black hair and the mask of his Degis – the eerie, elegant technology of his biometal suit – sparkles faintly. Usually in chaos, his gaze now burns low, lost in the fire.</p>
            ...
            <p>"Remember that time in the future," he says, "when Aesu accidentally exploded that living dimension? The look on its face—priceless!"</p>
            ...
            <p>A little apart, <strong>Brinia</strong> sits in silence. Her liquid biometal armor ripples with the fire's glow, green and alien. Her dual blade, AxoNexus, stands like a totem beside her. Eyes fixed on the flames, she seems lost — not in sorrow, but in memory.</p>
            ...
            <p>Everyone laughs. Warm, unguarded, real. The firelight sparks over their faces in beams of gold. The air hums with the crackle of embers and distant howls from unseen creatures. For a glowing moment, the world outside fades. Only they exist. <strong>Nuvine</strong>, the kid of the group, snores by the fire—dead to the world. Her silver cloak veils her robotic parts, the eyes are moved by her cold, ever-alert persona, <strong>Alter</strong>. As the others laugh, Alter gazes at the night sky. For a moment, it freezes. A voice stutters through the mist. "Hope is a virus," it whispers. Then nothing. No one else seems to notice. But Alter does not sleep. Alter never forgets. The stars arc deeper into the mist, as if the sky holds their hopes and fears, their dreams and doubts. And through it all, the fire burns as if endless, just like the bond between them. A flame not even time itself can extinguish. The fire of everything they survive, everything they are.</p>
            
            <p>Suddenly, a blinding light erupts from the embers, forcing Alter to shield Nuvine's face. The fire grows, twisting into a swirling vortex of energy. From its depths, a figure emerges—not of flesh and blood, but pure light and code. It is <strong>Zane</strong>, the creator of Zios, his form shimmering with an ethereal glow. His eyes fix on Alter, a knowing smirk playing on his lips.</p>
    ...
    "chapter3": {
        ...
        content: `
            ...
            <p>As Alter speaks, the mist around them thickens, distorting Zane's form into a swirling vortex of light. He doesn't pursue them directly, but his laughter echoes through the shifting landscape—a mocking, omnipresent sound.</p>
    ...
    "chapter4": {
        ...
        content: `
            ...
            <p>But Alter ignores him. Her focus is absolute. She dives deeper, bypassing Zane's defenses, navigating layers of encryption that would crush lesser minds. The sensation is immense—a surge of raw information, the collective subconscious of every soul trapped in Zios, feeding into her mind.</p>
            ...
            <p>Alter finds it—a pulsing nexus of pure energy, the very heart of Zane's control over the loop. It is a terrifyingly beautiful construct, shimmering with fractured timelines and forgotten memories. And within it, she sees a familiar symbol—the glowing letter, the one that resets the loop.</p>
    ...
    "chapter5": {
        ...
        content: `
            ...
            <p>They navigate a maze of shifting crystalline structures and ephemeral data streams. Suddenly, they stumble upon a hidden alcove—a small pocket of stability in the chaotic reality of Zios. Inside, a glowing, fragmented image flickers—a visual log, seemingly uncorrupted by Zane's influence. It appears to be an old recording of Zane himself, younger, a nascent brilliance in his eyes, working on the early iterations of Zios. He's speaking to an unseen individual, his voice clear and earnest, detailing his initial vision for Zios—a world of connection, of shared dreams.</p>
    ...
    "chapter7": {
        ...
        content: `
            ...
            <p>As Zane's attention diverts, Alter identifies a subtle ripple in the distorted landscape—a path that exists outside the dominant flow of Zios, a forgotten channel. It is unstable, dangerous, but it leads deeper into the system, bypassing the direct line of sight from Zane's central control.</p>
    ...
    "ending_usurper": {
        ...
        content: `
            ...
            <p>Nuvine opens her eyes. They are no longer the cold, glowing eyes of Alter, but her own—a vibrant, clear gaze. She feels… different. Connected. She feels the heartbeat of Zios, hears its whispers, understands its vast, intricate network. She <em>is</em> Zios, but she is still Nuvine. The loop is broken not by destruction, but by assimilation.</p>
    ...
    "ending_liberation": {
        ...
        content: `
            ...
            <p>"No!" Zane's voice echoes, filled with genuine terror for the first time. "You don't understand! Without me, Zios will collapse! Everyone trapped here will—"</p>
            ...
            <p>But Alter knows better. As Zios crumbles around them, she feels <strong>Nuvine's</strong> true consciousness awakening, no longer suppressed by the artificial constraints of the loop. <strong>Aesu</strong>, <strong>Lumi</strong>, <strong>Vonor</strong>, and <strong>Brinia</strong> begin to remember—not just their adventures in this digital prison, but their real lives, their real world, their real selves.</p>
            ...
            <p>Nuvine looks around at her friends—her real friends—and smiles. "Hope is no virus," she says softly, echoing the words from Aesu's letter. "And love is no corruption."</p>
            
            <p>As they help each other to their feet, ready to face whatever challenges await them in the real world, they know that their bond—forged in the fires of Zios—will endure. They have escaped the loop, but they carry with them the lessons learned and the love shared in that digital realm.</p>
    ...
    "chapter14": {
        ...
        content: `
            ...
            <p>As they progress, they encounter fragments of memories—echoes of other souls who have been trapped in Zios. Some are peaceful, others tormented. Alter realizes these are the remnants of everyone who has ever been caught in Zane's loop.</p>
    ...
    "chapter15": {
        ...
        content: `
            ...
            <p>The path leads them to a vast chamber where the walls pulse with a heartbeat-like rhythm. In the center stands a figure—not Zane as they know him, but his original form, before the corruption of power consumed him. This is Zane's true self, trapped and tormented by what he has become.</p>
    ...
    "ending_redemption": {
        ...
        content: `
            ...
            <p>As the true Zane reclaims control, <strong>Zios</strong> transforms. No longer a prison, it becomes what it was always meant to be—a place where consciousness can explore infinite possibilities while remaining grounded in human connection.</p>
